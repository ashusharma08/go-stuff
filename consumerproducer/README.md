...
Write a Go application that simulates the producer/consumer scenario above. Create

6 goroutines that model the above behaviour. Run the simulation until both consumers
...
Your solution should ensure there are no deadlocks, and that neither consumer is
