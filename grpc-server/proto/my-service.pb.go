...
const file_proto_my_service_proto_rawDesc = "" +
	"\n" +
	"\x16proto/my-service.proto\x12\x05agent\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2@\n" +
	"\x05Agent\x127\n" +
	"\bSayHello\x12\x13.agent.HelloRequest\x1a\x14.agent.HelloResponse\"\x00B.Z,github.com/esoptra/go-prac/grpc-server/agentb\x06proto3"
