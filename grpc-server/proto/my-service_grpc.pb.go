...
const (
	Agent_SayHello_FullMethodName = "/agent.Agent/SayHello"
)
...
func (c *agentClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, Agent_SayHello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAgentServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Agent_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_SayHello_FullMethodName,
	}
...
var Agent_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/my-service.proto",
}
